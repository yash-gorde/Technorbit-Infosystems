// 9. Write a C program to create an array of n elements using staticmemory allocation to accept position from user and delete an element at given position from an array.
#include<stdio.h>
void main()
{
