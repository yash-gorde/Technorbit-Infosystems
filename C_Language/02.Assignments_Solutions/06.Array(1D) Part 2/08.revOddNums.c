// 8. Write a C program to create an array of n elements using static memory allocation from user and replace all odd numbers by their reverse number.
#include<stdio.h>
void main() 
{
    ...
    printf("Array with positions having odd elements reversedersed is : \n");
    for(index = 0 ; index < numElements ; index++)
    {
