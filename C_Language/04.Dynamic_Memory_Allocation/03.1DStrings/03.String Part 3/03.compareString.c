// 3.Write a C program which accept two strings from user and compare two strings. If 
// both strings are equal then return 0 otherwise return difference between first 
// mismatch character.
// Eg:
